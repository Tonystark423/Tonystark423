...
def client():
    ...
    with app_module.app.test_client() as c:
        yield c
    # Restore module defaults so other test modules see their own credentials.
    app_module.app.config.pop("LEDGER_USER", None)
    app_module.app.config.pop("LEDGER_PASS", None)
